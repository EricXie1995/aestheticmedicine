								...
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-right">
										<div class="login-header">
											<h3>診所註冊 <a href="register.html">不是診所?</a></h3>
										</div>
										...
										<form action="<c:url value='doRegist'/>" method="post">
											...
											<div class="form-group form-focus">
												<input name="clinicName" type="text" class="form-control floating">
												<label class="focus-label">診所名稱</label>
											</div>
											<div class="form-group form-focus">
												<input name="clinicPhone" type="text" class="form-control floating">
												<label class="focus-label">電話</label>
											</div>
											<div class="form-group form-focus">
												<input name="clinicAddress" type="text" class="form-control floating">
												<label class="focus-label">住址</label>
											</div>

											<div class="text-right">
												<a class="forgot-link" href="/beauty/clinic/login_test">已經有註冊?</a>
												

											</div>
											<button class="btn btn-primary btn-block btn-lg login-btn" type="submit">註冊</button>
											<div class="login-or">
