					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								...
								<ul class="submenu">
									<li class="active"><a href="doctor-dashboard.html">診所面板</a></li>
									<li><a href="appointments.html">醫療團隊</a></li>
					...
					<ul class="nav header-navbar-rht">
						...
						<li class="nav-item dropdown has-arrow logged-item">
							<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
								<span class="user-img">
									<img class="rounded-circle" src="../assets/img/doctors/doctor-thumb-02.jpg" width="31" alt="診所名稱">
								</span>
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								<div class="user-header">
									...
									<div class="user-text">
										<h6>診所名稱</h6>
										<p class="text-muted mb-0">XX診所</p>
									</div>
								</div>
								<a class="dropdown-item" href="doctor-dashboard.html">診所面板</a>
								<a class="dropdown-item" href="doctor-profile-settings.html">診所資料</a>
						...
						<div class="col-md-12 col-12">
							<nav aria-label="breadcrumb" class="page-breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">診所面板</li>
								</ol>
							</nav>
							<h2 class="breadcrumb-title">診所面板</h2>
						</div>
					</div>
				</div>
			</div>
