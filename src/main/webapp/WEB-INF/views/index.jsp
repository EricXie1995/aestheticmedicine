          ...
          <div class="specialities-slider slider">
            ...
            <div class="speicality-item text-center">
              <div class="speicality-img">
                <img src="<c:url value='/assets/img/specialities/specialities-01.png'/>" class="img-fluid" alt="Speciality">
            ...
            <div class="speicality-item text-center">
              <div class="speicality-img">
                <img src="<c:url value='/assets/img/specialities/specialities-02.png'/>" class="img-fluid" alt="Speciality">
                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
              </div>
              <p>Neurology</p>
            </div>
            ...
            <div class="speicality-item text-center">
              <div class="speicality-img">
                <img src="<c:url value='/assets/img/specialities/specialities-03.png'/>" class="img-fluid" alt="Speciality">
                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
              </div>
              <p>Orthopedic</p>
            </div>
            ...
            <div class="speicality-item text-center">
              <div class="speicality-img">
                <img src="<c:url value='/assets/img/specialities/specialities-04.png'/>" class="img-fluid" alt="Speciality">
                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
              </div>
              <p>Cardiologist</p>
            </div>
            ...
            <div class="speicality-item text-center">
              <div class="speicality-img">
                <img src="<c:url value='/assets/img/specialities/specialities-05.png'/>" class="img-fluid" alt="Speciality">
                <span><i class="fa fa-circle" aria-hidden="true"></i></span>
              </div>
              <p>Dentist</p>
            </div>
        ...
        <div class="col-lg-8">
          <div class="doctor-slider slider">
            ...
            <div class="profile-widget">
              <div class="doc-img">
                <a href="doctor-profile.html">
                  <img class="img-fluid" alt="User Image" src="<c:url value='/assets/img/doctors/doctor-01.jpg'/>">
                </a>
            ...
            <div class="profile-widget">
              <div class="doc-img">
                <a href="doctor-profile.html">
                  <img class="img-fluid" alt="User Image" src="<c:url value='/assets/img/doctors/doctor-02.jpg'/>">
                </a>
                <a href="javascript:void(0)" class="fav-btn">
                  <i class="far fa-bookmark"></i>
                </a>
            ...
            <div class="profile-widget">
              <div class="doc-img">
                <a href="doctor-profile.html">
                  <img class="img-fluid" alt="User Image" src="<c:url value='/assets/img/doctors/doctor-03.jpg'/>">
                </a>
                <a href="javascript:void(0)" class="fav-btn">
                  <i class="far fa-bookmark"></i>
                </a>
            ...
            <div class="profile-widget">
              <div class="doc-img">
                <a href="doctor-profile.html">
                  <img class="img-fluid" alt="User Image" src="<c:url value='/assets/img/doctors/doctor-04.jpg'/>">
                </a>
                <a href="javascript:void(0)" class="fav-btn">
                  <i class="far fa-bookmark"></i>
                </a>
            ...
            <div class="profile-widget">
              <div class="doc-img">
                <a href="doctor-profile.html">
                  <img class="img-fluid" alt="User Image" src="<c:url value='/assets/img/doctors/doctor-05.jpg'/>">
                </a>
                <a href="javascript:void(0)" class="fav-btn">
                  <i class="far fa-bookmark"></i>
                </a>
            ...
            <div class="profile-widget">
              <div class="doc-img">
                <a href="doctor-profile.html">
                  <img class="img-fluid" alt="User Image" src="<c:url value='/assets/img/doctors/doctor-06.jpg'/>">
                </a>
                <a href="javascript:void(0)" class="fav-btn">
                  <i class="far fa-bookmark"></i>
                </a>
            ...
            <div class="profile-widget">
              <div class="doc-img">
                <a href="doctor-profile.html">
                  <img class="img-fluid" alt="User Image" src="<c:url value='/assets/img/doctors/doctor-07.jpg'/>">
                </a>
                <a href="javascript:void(0)" class="fav-btn">
                  <i class="far fa-bookmark"></i>
                </a>
            ...
            <div class="profile-widget">
              <div class="doc-img">
                <a href="doctor-profile.html">
                  <img class="img-fluid" alt="User Image" src="<c:url value='/assets/img/doctors/doctor-08.jpg'/>">
                </a>
                <a href="javascript:void(0)" class="fav-btn">
                  <i class="far fa-bookmark"></i>
                </a>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-5 features-img">
          <img src="<c:url value='/assets/img/features/feature.png'/>" class="img-fluid" alt="Feature">
        </div>
        <div class="col-md-7">
          <div class="section-header">
          ...
          <div class="features-slider slider">
            ...
            <div class="feature-item text-center">
              <img src="<c:url value='/assets/img/features/feature-01.jpg'/>" class="img-fluid" alt="Feature">
              <p>Patient Ward</p>
            </div>
            <!-- /Slider Item -->
            ...
            <!-- Slider Item -->
            <div class="feature-item text-center">
              <img src="<c:url value='/assets/img/features/feature-02.jpg'/>" class="img-fluid" alt="Feature">
              <p>Test Room</p>
            </div>
            <!-- /Slider Item -->
            ...
            <!-- Slider Item -->
            <div class="feature-item text-center">
              <img src="<c:url value='/assets/img/features/feature-03.jpg'/>" class="img-fluid" alt="Feature">
              <p>ICU</p>
            </div>
            <!-- /Slider Item -->
            ...
            <!-- Slider Item -->
            <div class="feature-item text-center">
              <img src="<c:url value='/assets/img/features/feature-04.jpg'/>" class="img-fluid" alt="Feature">
              <p>Laboratory</p>
            </div>
            <!-- /Slider Item -->
            ...
            <!-- Slider Item -->
            <div class="feature-item text-center">
              <img src="<c:url value='/assets/img/features/feature-05.jpg'/>" class="img-fluid" alt="Feature">
              <p>Operation</p>
            </div>
            <!-- /Slider Item -->
            ...
            <!-- Slider Item -->
            <div class="feature-item text-center">
              <img src="<c:url value='/assets/img/features/feature-06.jpg'/>" class="img-fluid" alt="Feature">
              <p>Medical</p>
            </div>
            <!-- /Slider Item -->
          </div>
