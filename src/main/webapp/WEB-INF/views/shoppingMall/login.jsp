...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div class="container-fluid" style="padding-top: 80px;padding-bottom: 80px" >
        ...
        <h1 class="title center">登入</h1>
        <br/>
        <div class="col-sm-offset-2 col-md-offest-2">
            <!-- 表单输入 -->
            <div  class="form-horizontal">
                <div class="form-group">
                    <label for="inputEmail" class="col-sm-2 col-md-2 control-label">信箱/帳號</label>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-6">
                        <button class="btn btn-lg btn-primary btn-block" type="submit" onclick="startLogin()">登入</button>
                    </div>
                </div>
            </div>
            <br/>
    ...
    <script type="text/javascript">
        function startLogin() {
            ...
            if(loginResult == 'success'){
                ...
                layer.msg('是不是帳號記錯了？',{icon:2});
            }
            else if(loginResult == 'wrong'){
                layer.msg('密碼不對喔，再想想~',{icon:2});
            }
