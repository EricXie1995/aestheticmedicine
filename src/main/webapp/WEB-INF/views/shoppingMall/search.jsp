		...
		<div class="row margin-t">
			<div class="form-horizontal">
				...
				<div class="form-group form-group-lg col-sm-6 col-md-6">
					<input type="text" class="form-control" id="newSearchKeyWord" placeholder="收尋你喜愛的商品" />
				</div>
				<button class="btn btn-primary btn-lg col-sm-2 col-md-2 big-button" onclick="searchPre()">尋找商品</button>
			</div>
		</div>
	</div>
	<div class="container">
  ...
  <script type="text/javascript">
	  ...
	  function search(searchKeyWord) {
		  ...
		  $.ajax({
			  async : false,
			  type : 'POST',
			  url : '${cp}/shoppingMall/searchProduct',
			  data : search,
			  dataType : 'json',
	  ...
	  function updateList(searchKeyWord) {
		  ...
		  for(var i=0;i<searchResult.length;i++){
			  var imgURL = "${cp}/Mall/img/"+searchResult[i].id+".jpg";
